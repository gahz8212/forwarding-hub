...
export const sendPdfToShipper = async (req: Request, res: Response) => {
  ...
  try {
    ...
    await pageInvoice.goto('about:blank');
    await pageInvoice.setContent(invoiceHtml, { waitUntil: 'load' });
    ...
    await pagePacking.goto('about:blank');
    await pagePacking.setContent(packingHtml, { waitUntil: 'load' });
